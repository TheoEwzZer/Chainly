    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure the Claude AI model and prompt for this node.
          </DialogDescription>
        </DialogHeader>
        <form
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  ...
                  <FieldDescription>
                    ...
                    {`{{${watchVariableName || "claudeResponse"}.text}}`}
                  </FieldDescription>
                  <Input
                    {...field}
                    id={field.name}
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field orientation="vertical" data-invalid={fieldState.invalid}>
                <FieldContent>
                  <FieldLabel htmlFor="anthropic-credential">
                    API Key
                  </FieldLabel>
                  <FieldDescription>
                    {!credentials?.length && (
          ...
          {(!credentials || credentials.length === 0) && (
            <Empty className="border">
              <EmptyHeader>
                ...
                <EmptyDescription>
                  You need to add an Anthropic API key before configuring this
                  node. Create one in the{" "}
            ...
            <>
              <Controller
                ...
                render={({ field, fieldState }) => (
                  ...
                  >
                    <FieldContent>
                      <FieldLabel htmlFor="anthropic-model">Model</FieldLabel>
                      {fieldState.invalid && (
                        <FieldError errors={[fieldState.error]} />
                      )}
                    </FieldContent>
